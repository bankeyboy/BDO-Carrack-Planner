...
def main():
    ...
    icon_by_thai = {
        "เรือเอเฟเรีย : หัวเรือเก่า": icons.get("Epheria: Old Figurehead"),
        "เรือเอเฟเรีย : หุ้มเกราะเก่า": icons.get("Epheria: Old Plating"),
        "เรือเอเฟเรีย : ปืนใหญ่เก่า": icons.get("Epheria: Old Cannon"),
        "เรือเอเฟเรีย : ใบเรือแล่นลมเก่า": icons.get("Epheria: Old Wind Sail"),
        ...
        "แท่งโลหะควันมืดต่อเติม": icons.get("Graphite Ingot for Upgrade x100"),
        "ไม้สำหรับต่อเติม": icons.get("Timber for Upgrade x100"),
        "กาวสำหรับต่อเติม": icons.get("Adhesive for Upgrade x100"),
        ...
        "เรือการค้าเอเฟเรีย : หัวเรือทองเหลือง": icons.get("+10 Epheria Caravel: Brass Figurehead x1"),
        "เรือการค้าเอเฟเรีย : หุ้มเกราะแข็งแกร่ง": icons.get("+10 Epheria Caravel: Enhanced Plating x1"),
        "เรือการค้าเอเฟเรีย : ปืนใหญ่เวริสชาร์": icons.get("+10 Epheria Caravel: Verisha Cannon x1"),
        "เรือการค้าเอเฟเรีย : ใบเรือไวท์วินด์": icons.get("+10 Epheria Caravel: White Wind Sail x1"),
        "เรือการค้าเอเฟเรีย : หัวเรือมังกรดำ": icons.get("+10 Epheria Caravel: Black Dragon Figurehead"),
        "เรือการค้าเอเฟเรีย : หุ้มเกราะดัดแปลง": icons.get("+10 Epheria Caravel: Upgraded Plating"),
        "เรือการค้าเอเฟเรีย : ปืนใหญ่เมย์นา": icons.get("+10 Epheria Caravel: Mayna Cannon"),
        "เรือการค้าเอเฟเรีย : ใบเรือแล่นลมชั้นเมฆ": icons.get("+10 Epheria Caravel: Stratus Wind Sail"),
